...
import org.springframework.stereotype.*;
			...
			file.writeln(0, "import " + Utils.getImportControllerPackageName(true) + ".GenericController;");
			...
			file.writeln(0, "public class " + upperCaseName + "Controller extends GenericController<" + upperCaseName + "> {");
			file.writeln(0, "");
