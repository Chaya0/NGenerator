...
public class AngularInsertFormComponentWriter implements ComponentWriter {
	...
	public void writeScript(Entity entity, boolean overwrite) throws Exception {
		...
		try (GeneratorOutputFile file = WriterUtils.getOutputResource(WriterUtils.getFrontendFeaturesEntitiesPath() + kebabCase + "/" + kebabCase + "-insert-form", StringUtils.camelToKebabCase(entity.getName()) + "-insert-form.component.ts", overwrite)) {
			file.writeln(0, "import { Component } from '@angular/core';");
			file.writeln(0, "import { GenericInsertFormComponent } from '../../../../core/components/generic-insert-form/generic-insert-form.component';");
			file.writeln(0, "");
	...
	public void writeStyles(Entity entity, boolean overwrite) throws Exception {
		String kebabCase = StringUtils.camelToKebabCase(entity.getName());
		try (GeneratorOutputFile file = WriterUtils.getOutputResource(WriterUtils.getFrontendFeaturesEntitiesPath() + kebabCase + "/" + kebabCase + "-insert-form", StringUtils.camelToKebabCase(entity.getName()) + "-insert-form.component.css", overwrite)) {
			file.writeln(0, "");
		}
	}
	...
	public void writeHTML(Entity entity, boolean overwrite) throws Exception {
		String kebabCase = StringUtils.camelToKebabCase(entity.getName());
		try (GeneratorOutputFile file = WriterUtils.getOutputResource(WriterUtils.getFrontendFeaturesEntitiesPath() + kebabCase + "/" + kebabCase + "-insert-form", StringUtils.camelToKebabCase(entity.getName()) + "-insert-form.component.html", overwrite)) {
